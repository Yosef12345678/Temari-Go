...
import routeRunRoutes from './routes/routeRun.routes';
import routeRunAssignmentRoutes from './routes/routeRunAssignment.routes';
...
app.use('/api/route-runs', routeRunRoutes);
app.use('/api/route-run-assignments', routeRunAssignmentRoutes);
