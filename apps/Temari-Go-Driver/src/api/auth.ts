...
export async function driverRegister(body: DriverRegisterRequest): Promise<ApiEnvelope<DriverRegisterData>> {
  return await request<ApiEnvelope<DriverRegisterData>>('POST', '/auth/driver/register', { auth: false, body });
}
